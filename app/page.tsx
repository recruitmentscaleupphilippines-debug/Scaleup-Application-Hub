 ...
 return <div className="shell">
  ...
  <main>
   ...
   <div className="content">
    <section className="welcome"><div><p>Tuesday, August 25</p><h1>Good morning, {profile.full_name.split(" ")[0]} <span>👋</span></h1><h2>Here’s what needs your attention today.</h2></div><button className="outline"><Sparkles size={17}/> View my priorities</button></section>
